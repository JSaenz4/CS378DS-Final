...
Chase went the opposite way; they offered le
...
This graph compares the number of complaints and untimely complaints though Citi Bank is fairly close. Here we can see that the Bank of America has the largest percentage of untimely complaints and largest number of complaints.
